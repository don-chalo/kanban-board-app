...
Only the Board Creator or Board Owner SHALL edit board attributes, manage the Associated members, or change the board's lifecycle state.
...
- **WHEN** an Associated member attempts to edit board attributes, manage members, or change board state
